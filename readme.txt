...
The water effect was achieved by (1) creating a "waterplane" prefab which was then instantiated at a specified height relative to the average height of vertices (slightly below) in the terrain. (2) The wave effect was done by applying a sin wave effect to the "waterplane" in its shader. 

????
The transparency of the water was also done in its shader, by making changes to the selected water texture's alpha value.
...
Stars were just added as an afterthought. From ASSET STORE.
